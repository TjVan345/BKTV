<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeBehind="OrderProduct.aspx.cs" Inherits="BK_TJ.WebForm11" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <%-- Name --%>
    <div class="row">
        <div class="col-sm-offset-1" style="width:100%;">
    ...
    <div class="row">
        <div class="col-sm-offset-1 col-sm-1">
            <asp:Label ID="lblPrice1" runat="server" Text="Total: "></asp:Label>
        </div>
        <div class="col-sm-3">
